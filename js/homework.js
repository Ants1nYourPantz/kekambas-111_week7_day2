...
class User{
    ...
    changePassword(password, new_password){
        if (this.password === password){
            ...
            console.log(`Your password has been changed to ${new_password}.`)
        } else {
            console.log('You entered the wrong password. Please try again.')
        }
    }
}


let user = new User('ants', 'abc');

console.log(user);
user.changePassword('abc', '123');
console.log(user);
